  ...
  return (
    <div>
      <button
        ...
        data-toggle="modal"
        data-target="#import"
        className="inline-block px-8 py-2 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer active:opacity-85 leading-pro text-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 hover:scale-102 active:shadow-soft-xs border-[#4D32BA] text-[#4D32BA] hover:text-[#4D32BA] hover:opacity-75 hover:shadow-none active:scale-100 active:border-[#4D32BA] active:bg-gradient-to-tl from-primary to-[#1E79DE] active:text-white hover:active:border-[#4D32BA] hover:active:bg-transparent hover:active:text-[#4D32BA] hover:active:opacity-75"
      >
        Import
      </button>
          ...
          <div className="relative flex flex-col w-full bg-white border border-solid pointer-events-auto dark:bg-gray-950 bg-clip-padding border-black/20 rounded-xl outline-0">
            ...
            <div className="flex flex-wrap items-center justify-end p-3 border-t border-solid shrink-0 border-slate-100 rounded-b-xl">
              ...
              <button
                ...
                data-toggle="modal"
                data-target="#import"
                className="inline-block px-8 py-2 m-1 mb-4 text-xs font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer ease-soft-in leading-pro tracking-tight-soft bg-gradient-to-tl from-primary to-[#1E79DE] shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85"
              >
                Upload
              </button>
            </div>
