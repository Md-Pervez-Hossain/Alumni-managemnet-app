  ...
  return (
    <div className="">
      <InnerPageHeader
        title={"About Us"}
        img={student}
        description={"There are many company Lorem ipsm dolor sitg amet, csetur "}
      ></InnerPageHeader>
      ...
      <div className="md:w-9/12 mx-auto grid md:grid-cols-2 px-5  gap-16 items-center my-16">
        <div>
          ...
          <p>
            ...
            dignissimos nulla? Repellendus quidem ad, debitis illo harum officiis minima
            quis nostrum voluptates atque fugiat exercitationem veniam illum suscipit
            nulla?.Lorem ipsum dolor sit amet consectetur adipisicing elit. Error aliquam
            dignissimos nulla? Repellendus quidem ad, debitis illo harum officiis minima
            quis nostrum voluptates atque fugiat exercitationem veniam illum suscipit.
          </p>
        </div>
